...
const Schema: z.ZodType<Prisma.ChoreCompletionUpdateWithoutCompletedByUserInput> =
    z
        .object({
            id: z
                .union([
...
export const ChoreCompletionUpdateWithoutCompletedByUserInputObjectSchema =
    Schema
