...
const Schema: z.ZodType<Prisma.ChoreCompletionUncheckedUpdateManyWithoutChoreNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const ChoreCompletionUncheckedUpdateManyWithoutChoreNestedInputObjectSchema =
    Schema
