...
const Schema: z.ZodType<Prisma.ChoreUncheckedCreateNestedManyWithoutHomeInput> =
    z
        .object({
            create: z
                .union([
...
export const ChoreUncheckedCreateNestedManyWithoutHomeInputObjectSchema = Schema
