...
const Schema: z.ZodType<Prisma.ChoreCompletionUpdateManyWithWhereWithoutChoreInput> =
    z
        .object({
...
export const ChoreCompletionUpdateManyWithWhereWithoutChoreInputObjectSchema =
    Schema
