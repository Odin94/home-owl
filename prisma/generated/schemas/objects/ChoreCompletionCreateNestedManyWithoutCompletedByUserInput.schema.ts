...
const Schema: z.ZodType<Prisma.ChoreCompletionCreateNestedManyWithoutCompletedByUserInput> =
    z
        .object({
            create: z
                .union([
...
export const ChoreCompletionCreateNestedManyWithoutCompletedByUserInputObjectSchema =
    Schema
