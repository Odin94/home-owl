...
const Schema: z.ZodType<Prisma.ChoreUncheckedUpdateManyWithoutHomeNestedInput> =
    z
        .object({
            create: z
                .union([
                    ...
                    z
                        .lazy(() => ChoreCreateWithoutHomeInputObjectSchema)
                        .array(),
                    z.lazy(
...
export const ChoreUncheckedUpdateManyWithoutHomeNestedInputObjectSchema = Schema
