...
const Schema: z.ZodType<Prisma.ChoreCompletionUpdateManyWithoutCompletedByUserNestedInput> =
    z
        .object({
            create: z
                .union([
...
export const ChoreCompletionUpdateManyWithoutCompletedByUserNestedInputObjectSchema =
    Schema
