...
const Schema: z.ZodType<Prisma.ChoreCompletionCreateNestedManyWithoutChoreInput> =
    z
        .object({
            create: z
                .union([
...
export const ChoreCompletionCreateNestedManyWithoutChoreInputObjectSchema =
    Schema
