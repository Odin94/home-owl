...
const Schema: z.ZodType<Prisma.UserCreateNestedManyWithoutHomeInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => UserCreateWithoutHomeInputObjectSchema),
                z.lazy(() => UserCreateWithoutHomeInputObjectSchema).array(),
                z.lazy(() => UserUncheckedCreateWithoutHomeInputObjectSchema),
                z
                    .lazy(() => UserUncheckedCreateWithoutHomeInputObjectSchema)
                    .array(),
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => UserCreateOrConnectWithoutHomeInputObjectSchema),
                z
                    .lazy(() => UserCreateOrConnectWithoutHomeInputObjectSchema)
                    .array(),
            ])
            .optional(),
        createMany: z
...
export const UserCreateNestedManyWithoutHomeInputObjectSchema = Schema
